...
| [**NASDAQ-100 Portfolio Optimization**](https://github.com/jhwang20/NASDAQ-100-Portfolio-Optimization) <br>(2025) | Built an efficient frontier of NASDAQ-100 stocks by optimizing risk-return profiles using historical price data. | Python · NumPy · Matplotlib · Portfolio Theory |
| [**Production & Pricing Optimization**](https://github.com/jhwang20/Production-and-Pricing-Optimization-using-Non-Linear-Techniques) <br>(2025) | Solved a joint production and pricing model using non-linear programming to maximize profits under cost and capacity constraints. | Python · SciPy.optimize · Non-Linear Programming |
